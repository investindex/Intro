...
You can see the names and descriptions of each section below, as well as my estimate of how long each section takes to read at a slow speed suitable for processing new concepts. The estimate includes only the main text, and not the time taken to click to the hyperlinks or read the footnotes. Throughout the guide, many hyperlinks to accessible resources are included to make it easy to learn more than is presented in the text. You may want to click on them as you read or return to them afterward.
...
* [Tax-advantaged accounts](https://github.com/investindex/TaxAdv) - intro to tax-advantaged investing
